export let mapObjects = [
    ...
    },
    {
        ...
        longDescription: "Often species are transported across the world, out of the ecosystems they have evolved in. This happens unintentionally through the global shipping trade, and intentionally when people bring plants and animals home with them. Often these exotic species do poorly, but sometimes they survive and thrive.\nThese species come to a new ecosystem without their natural enemies, and they are subject to minimal environmental resistance. Exotic species can quickly outcompete native species, and destroy biodiversity again, forcing remaining populations to adapt. In this simulation, you will examine how a population changes as the plant community is taken over by an exotic species."
    },
    {
        ...
        longDescription: "Pesticides are chemicals that kill pests. They have been commonly used to keep unwanted pests out of our houses and out of our crops. One of the problems associated with the improper and consistent use of pesticides is that populations of pests may becomes resistant to a specific chemical. The process by which this happens is natural selection and human activity speeds it up.\nFor example, some of the insects in a population of pests may have a genetic variation that prevents them from being killed by an insecticide. As a farmer sprays pesticides on his field to kill this pest, the insects that can't be killed survive to reproduce, passing the genetic variation that allows for them to be resistant to the insecticide on to their offspring.\nIMPORTNAT: In this simulation, one color of pests will become immune to the killing effects of an insecticide after the third generation. During the last two generations, one color will be immune to the pesticide (represented by mouse clicks). You will explore what happens to the population with this environmental pressure."
    },
    {
    ...
    },
    {
        ...
        longDescription: "Natural disasters as a result of human activity. A natural disaster is a natural occurrence, usually sudden and often intense. Examples include wildfire, flood, blizzard, earthquake, tornado, hurricane, wind or ice storm. Some can be caused by humans:\n\n\t-Some forest fires are a result of unattended campfires or carelessly tossed cigarette butts\n\t-Flooding may be a result of human-made dams and levees\n\t-Scientists are seeing an increase in hurricanes correlated with climate change.\n\nThe resulting damage to the environment can have a serious negative effect on the diversity of an ecosystem by killing individuals, destroying shelters, and limiting resources for survivors. Within generations, populations can recover. This simulation will recreate how natural selection plays a role after a natural disaster occurs."
    }
]